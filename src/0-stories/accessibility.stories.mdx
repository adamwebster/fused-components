...
If you are using one of the many input like components in this library and they are not tied to a **label** then it is suggested that use use the property **aria-label** to the input.
